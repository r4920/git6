...
router.route('/admin/master/deleteMany').post(auth(...[ 'deleteManyByAdminInAdminPlatform' ]),checkRolePermission,MasterController.deleteManyMaster);
...
router.route('/admin/master/delete/:id').delete(auth(...[ 'deleteByAdminInAdminPlatform' ]),checkRolePermission,MasterController.deleteMaster);
