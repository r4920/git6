...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Darron.Hermann',
      password: 'nuedcw1iV9PfjgK',
      email: 'Janis_Mann@yahoo.com',
      name: 'Ms. Shari Kertzmann',
      mobileNo: '721-614-3849 x07002',
      userType: 876,
      resetPasswordLink: {},
      loginRetryLimit: 404,
      loginReactiveTime: '2022-09-11T06:29:58.304Z',
      id: '62286d4c97e5c30aa2f42c78'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Harmony.Brekke',
        'password':'VDBWIUZ1GEE92go',
        'email':'Norbert72@hotmail.com',
        'name':'Ryan Paucek',
        'mobileNo':'733.770.6510',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Norbert72@hotmail.com', });
