...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Aileen77',
      password: 'zAtYQgY1yXIPjGO',
      email: 'Anna30@gmail.com',
      name: 'Glen Stark',
      mobileNo: '426.942.9878 x76826',
      userType: 431,
      resetPasswordLink: {},
      loginRetryLimit: 737,
      loginReactiveTime: '2023-02-18T15:32:10.424Z',
      id: '62286d4c97e5c30aa2f42cf9'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Milan.Roob36',
        'password':'MGak6SxubqRrIUo',
        'email':'Oceane58@gmail.com',
        'name':'Lynne Kerluke',
        'mobileNo':'951.631.0768',
